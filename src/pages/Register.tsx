                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <div className="relative flex-1">
                            <input
                                ...
                                required
                                className="w-full px-4 py-4 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-600/50 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all shadow-sm placeholder:text-slate-400"
                            />
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            required
                            className="w-full pl-12 pr-4 py-4 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-600/50 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all shadow-sm text-slate-700 dark:text-slate-200"
                        />
                    </div>
