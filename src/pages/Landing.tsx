        ...
        <div className="min-h-[100dvh] bg-background relative overflow-hidden flex flex-col">
            ...
            <nav className="relative z-10 flex items-center justify-between p-6 max-w-5xl mx-auto w-full">
                <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-white rounded-xl shadow-floating flex items-center justify-center">
                        <span className="font-bold text-textMain text-sm">PD</span>
                    </div>
                    <span className="font-bold text-textMain tracking-tight">Podaryavai</span>
                </div>
                ...
                >
                    {features.map((feature, idx) => (
                        <motion.div
                            key={idx}
                            variants={fadeIn}
                            className="p-6 bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-sm hover:shadow-floating transition-all group"
                        >
                            ...
                            <h3 className="text-xl font-bold text-textMain mb-2">{feature.title}</h3>
