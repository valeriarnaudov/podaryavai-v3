    ...
    return (
        ...
        >
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-slate-900">Automated Notifications</h2>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 mt-1 flex items-center space-x-2">
                                            <span className="font-semibold px-2 py-0.5 bg-slate-200 rounded-md text-[10px]">{log.notification_type}</span>
